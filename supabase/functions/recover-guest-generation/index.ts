    ...
    return jsonResponse({
      ...
      memory: {
        ...
        sentences: sentences.map((sentence: any) => ({
          ...
          is_favorite: false,
          coarse_category: typeof sentence?.coarse_category === "string" ? sentence.coarse_category : null,
          study_topic: typeof sentence?.study_topic === "string" ? sentence.study_topic : null,
          fine_categories: Array.isArray(sentence?.fine_categories) ? sentence.fine_categories : [],
        })),
      },
